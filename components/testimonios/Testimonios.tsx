...
export default function Testimonios() {
  return (
    <>
      <section className='mb:py-0 relative z-[1] w-full bg-claro py-12 font-poppins'>
        ...
        <article className='relative mx-auto flex h-auto w-full max-w-[100rem] flex-col items-start justify-start gap-4 px-4 py-12 md:px-8 md:py-16 lg:py-32'>
          <div className='relative flex w-full flex-col items-end justify-start lg:absolute'>
          ...
          <div className='contenedor-slider-testimonios relative inset-0 top-0 flex w-full flex-col gap-8 pb-0'>
            <SliderTestimonios />
          </div>
        </article>
      </section>
